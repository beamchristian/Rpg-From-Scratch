...
public class WardrobePrefabManagerEditor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        if (wardrobePrefabManager.showHelpBoxes)
        {
            EditorGUILayout.HelpBox("Wardrobe Prefab Manager\n" +
                                    "TO BE UPDATED", MessageType.None);
        }

        wardrobePrefabManager.showSetup = EditorGUILayout.Foldout(wardrobePrefabManager.showSetup, "Setup & Options");
        if (wardrobePrefabManager.showSetup)
        {
            EditorGUI.indentLevel++;
            wardrobePrefabManager.showHelpBoxes = EditorGUILayout.Toggle("Show help boxes", wardrobePrefabManager.showHelpBoxes);
            wardrobePrefabManager.showFullInspector = EditorGUILayout.Toggle("Show full inspector", wardrobePrefabManager.showFullInspector);
        ...
        if (wardrobePrefabManager.handleBlendShapes)
        {
            ...
            wardrobePrefabManager.showBlendShapeManagement = EditorGUILayout.Foldout(wardrobePrefabManager.showBlendShapeManagement, "Blend Shape Management");
            if (wardrobePrefabManager.showBlendShapeManagement)
        ...
        /* ------------------------------------------------------------------------------------------
         DEFAULT INSPECTOR
         ------------------------------------------------------------------------------------------*/
        if (wardrobePrefabManager.showFullInspector)
        {
            EditorGUILayout.Space();
